...
export default function About() {
  ...
  const sections = useSitePage("about");
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 md:py-20">
          {rest.length === 0 ? null : rest.map((s) => {
            if (s.type === "stat_cards") return <StatCardsSection key={s.id} lang={lang} d={s.data || {}} />;
            if (s.type === "about_story") return <StorySection key={s.id} lang={lang} d={s.data || {}} />;
            return null;
          })}
        </div>
      </section>
