...
export const SECTION_META = {
  hero: {
    ...
    fields: [TXT("eyebrow", "Label kecil (eyebrow)"), TXT("title", "Judul besar"), TA("subtitle", "Subjudul"),
      TXT("image", "URL gambar latar"), { key: "chips", label: "Chip keunggulan (satu per baris)", kind: "lines" },
  ...
  page_hero: {
    ...
    fields: [TXT("eyebrow", "Eyebrow"), TXT("title", "Judul"), TA("subtitle", "Subjudul"), TXT("image", "URL gambar latar")],
  },
  stat_cards: {
